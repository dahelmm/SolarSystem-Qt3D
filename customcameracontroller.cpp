...
//    m_key9Pressed = false;
    ...
    m_key1Input  = new Qt3DInput::QActionInput(this);
    m_key1Action = new Qt3DInput::QAction(this);
    ...
    m_key1Action->setObjectName("Camera_Merc");
...
//    m_key3Action->setObjectName("CameraEarth");
    ...
    m_logicalDevice->addAction(m_key1Action);
    ...
    connect(m_key1Action,SIGNAL(activeChanged(bool)),this,SLOT(activeChenged(bool)));
...
void customCameraController::activeChenged(bool isActive)
{
    ...
    else if(sender()->objectName()=="Camera_Merc")
    {
        m_key1Pressed = isActive;
    }
}
...
{    
    ...
    if (m_keyMinPressed ==true)
    {
        ...
        posCamera.setX(((cX<0)&&(cX!=0))?cX+dt*100:cX-dt*1000);
        posCamera.setY(((cY<0)&&(cY!=0))?cY+dt*100:cY-dt*1000);
        posCamera.setZ(((cZ<0)&&(cZ!=0))?cZ+dt*100:cZ-dt*1000);
